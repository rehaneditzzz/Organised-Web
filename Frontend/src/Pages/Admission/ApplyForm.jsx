...
const ApplyForm = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-300 p-4 pt-20 md:p-36 lg:p-40">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl text-purple-800 font-bold text-center">
        Student Registration Form
      </h1>
      <div className="bg-white p-6 sm:p-10 lg:p-16 mt-4 rounded-lg shadow">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errors.placeOfBirth && (
                <p className="text-red-500 text-xs">{errors.placeOfBirth.message}</p>
              )}
            </div>
          ...
          <button
            ...
            className={`mt-6 w-full block sm:w-1/2 lg:w-1/3 mx-auto bg-purple-600 text-white p-3 rounded ${
              isSubmitting
